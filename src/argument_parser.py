...
Examples:
  ...
  python wunderground_to_aprs_sender.py --show-config
        ...
        parser.add_argument('station_id', nargs='?', help='Weather station ID (e.g., YOUR_STATION_ID)')
        parser.add_argument('callsign', nargs='?', help='Your amateur radio callsign')
        parser.add_argument('passcode', nargs='?', type=int, help='APRS-IS passcode for transmitting')
        
        # Named optional arguments
        parser.add_argument('--station', help='Weather station ID (alternative to positional argument)')
